...
| <a name="input_prefix"></a> [prefix](#input\_prefix) | (Required) Prefix to use for all resources in this module. | `string` | `"tacowagongitops"` | no |
| <a name="input_region"></a> [region](#input\_region) | (Optional) AWS Region to deploy in. Defaults to us-east-1. | `string` | n/a | yes |
